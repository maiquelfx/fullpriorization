...
#C:\Users\USER\Documents\Ciencias Atuariais\Mestrado\PERÍODOS\1\TESTE DE SOFTWARE\SEMINÁRIO\PYTEST\GITHUB\TESTE1>python -m pytest -v test_main.py
#python -m pytest -v test_main_rel.py
...
for i in range(num_inicial, num_inicial + n):
    ...
    teste_str += f'prazo={prazo}\n'
    teste_str += f"dicio['t{i}'] = (complexidade, risco, prazo)\n "
    dados_testes_str += teste_str
    dados_testes_str += '\n'

# Agora, temos todos os dados dos testes em uma única string com quebras de linha
